...
const Cart = () => {
  ...
  return (
    <main>
      {/* PAGE HEADER */}
      <section className="bg-gradient-to-r from-purple-50 to-indigo-50 py-12 px-6 md:px-8 lg:px-12">
          ...
          {cartItems.length === 0 ? (
            <div className="text-center py-20">
              <div className="flex justify-center mb-4">
                <i className="fas fa-shopping-cart text-8xl text-gray-300"></i>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                  {cartItems.map((item) => {
                    ...
                    return (
                      <div
                        key={productId}
                        className="flex items-center gap-6 p-6 border-b border-gray-200 hover:bg-gray-50"
                      >
                        <img
                          src={image}
                          alt={productName}
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-blue-600 font-bold">
                            Rs. {(productPrice || 0).toLocaleString()}
                          </p>
                        </div>
                ...
                <Link
                  to="/products"
                  className="inline-flex items-center gap-2 mt-6 text-blue-600 font-bold hover:underline"
                >
              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-20 h-fit">
                  ...
                  <Link
                    to="/checkout"
                    className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold hover:bg-blue-700 flex items-center justify-center gap-2 mb-3"
                  >
